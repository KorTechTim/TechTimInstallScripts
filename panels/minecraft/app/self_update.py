...
TARGET_CONTAINER = os.getenv("TARGET_CONTAINER", "minecraft-panel")
PROXY_CONTAINER = os.getenv("PROXY_CONTAINER", "minecraft-panel-proxy")
TARGET_IMAGE = os.getenv("TARGET_IMAGE", "ghcr.io/kortechtim/minecraft-panel:latest")
